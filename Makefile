...
OBJDIR=obj
MAIN=src\main.cpp
PROJ_LIBS= Alien Bullet Camera CameraFollower Collider Game GameObject InputManager Minion Music PenguinBody PenguinCannon Rect Resources Sound Sprite StageState TileMap TileSet Utility Vec2
