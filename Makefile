...
OBJDIR=obj
MAIN=src\main.cpp
PROJ_LIBS= Alien Bullet Camera CameraFollower Game GameObject InputManager Minion Music PenguinBody PenguinCannon Rect Resources Sound Sprite State TileMap TileSet Vec2
